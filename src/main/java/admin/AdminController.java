...
public class AdminController {
	...
	public String List(Model model, HttpServletRequest req) {
		...
		// MyBatis 기본쿼리출력
		String sql = sqlSession.getConfiguration().getMappedStatement("list").getBoundSql(memberDTO).getSql();
	...
	public String modify(Model model, HttpServletRequest req, HttpSession session) {
		...
		MemberDTO dto = sqlSession.getMapper(MemberImpl.class).view(memberDTO);
	...
	public String modifyAction(HttpSession session, MemberDTO memberDTO) {
		...
		int applyRow = sqlSession.getMapper(MemberImpl.class).modify(memberDTO);
	...
	public String delete(HttpServletRequest req) {
		...
		sqlSession.getMapper(MemberImpl.class).delete(req.getParameter("id"));
