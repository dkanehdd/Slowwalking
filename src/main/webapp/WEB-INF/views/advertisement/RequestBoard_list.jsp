		...
		<div class="RequestBoardList">	
			...
			<c:if test="${list_flag ne 'mylist' }">
				<div class="container-1" data-aos="fade-up" data-aos-delay="400">
					...
					method="post" 
					class="form reqFrm" style="width:100%;">
						...
						<button type="submit" class="btn btn-info btnSch">
...
<!-- 							<p style="color: ##">※가능한 시간을 체크해주세요 체크하지 않으면 모든 시간이 검색됩니다.</p> -->
							...
							<input type="hidden" id="consultation" name="consultation" value="협의 가능">
							<br/>
...
<!-- 							<p style="color: #FFC079">※원하시는 지역을 선택해주세요. 선택하지 않으시면 전체 지역으로 검색됩니다.</p> -->
							...
							<span id="catetd1" class="area2ck" style="width: 30%; position: unset; margin: 0"> 
								<br/>	
